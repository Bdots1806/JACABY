<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(file_exists("certificate/".$enrollment.".jpg")){
            $imgname = $enrollment;
            $pass = 1;    
            //-----------------------------------------------------------------------------------------
            $image = "certificate/".$imgname.".jpg";                          //image path
    ...
    <div>
        ...
        <div class="w3-white w3-padding-16">
            <div class="w3-center w3-xxxlarge animate-top-1">
                <a href="http://ronak.ml/project/">
                    <span class="thin w3-tag w3-black">HTML</span><span class="thick" style="padding-left: 7px;padding-right: 7px;">CSS</span>
                </a>
            </div>
        </div>
        ...
        <div class="w3-center w3-padding-16 s-white-text w3-xxlarge">
            <div class="animate-top-2">
                <span class="thick">Enter Your Enrollment & </span><span class="thick">Get eCertificate</span>
            </div>
        </div>
<?php
    if( $pass == 0) {
        ...
        <div id="id01" class="w3-modal">
            <div class="w3-modal-content w3-card-4  w3-animate-zoom">
                <header class="w3-container w3-blue"> 
                    ...
                    <center><h2>eCertificate</h2></center>
                </header>
        ...
        if($fail == 1) { // try 
            ...
            <div style="display:none;" id="myDiv" class="animate-bottom">
                <div class=" w3-padding-small w3-center">
                    <?php  
                        echo '<img class="w3-image" alt="Certificate" src="',$src,'" width="750"/>';
                    ?>
                        <div class="w3-animate-bottom w3-center">
                            <?php 
                                echo '<a href="',$src,'" download="'.$imgname.'">'
                            ?> 
